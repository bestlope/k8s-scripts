...
```
mkdir -p editor && cd ./editor && CURR_DIR=$(pwd)
...
PROM_EU1_0_EXT_ADDRESS=https://2886795313-${PROM_EU1_0_PORT}-elsy05.environments.katacoda.com && \
PROM_EU1_1_EXT_ADDRESS=https://2886795313-${PROM_EU1_1_PORT}-elsy05.environments.katacoda.com && \
PROM_US1_0_EXT_ADDRESS=https://2886795313-${PROM_US1_0_PORT}-elsy05.environments.katacoda.com
```
...
Visit https://2886795313-9090-elsy05.environments.katacoda.com to see Thanos UI.
Yolo Demo Resources
Long term retention!
...
We can check whether the data is uploaded into thanos bucket by visitng Minio (or localhost:9000) It will take a minute to synchronize all blocks. Note that sidecar by default uploads only "non compacted by Prometheus" blocks.

See this to read more about uploading old data already touched by Prometheus.
...
Visit https://2886795313-19095-elsy05.environments.katacoda.com/new/loaded to see Compactor Web UI.

Data should be immdiately downsampled as well for smooth expierience!
Visit https://2886795313-9090-elsy05.environments.katacoda.com to see Thanos UI and query for 1 year.
